data:extend(
{
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/advanced-nuclear-fuel-reprocessing.png",
        icon_size = 32,
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/plutonium-fuel-reprocessing.png",
        icon_size = 32,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/thorium-fuel-reprocessing.png",
        icon_size = 32,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/neptunium-fuel-reprocessing.png",
        icon_size = 32,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/upgraded-plutonium-fuel-reprocessing.png",
        icon_size = 32,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/uranium-neutron-absorption.png",
        icon_size = 32,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/thorium-processing.png",
        icon_size = 32,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/thorium-neutron-absorption.png",
        icon_size = 32,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/uranium-hexafluoride.png",
        icon_size = 64,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/low-enriched-uranium-hexafluoride.png",
        icon_size = 64,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        enabled = false,
        category = "centrifuging",
        ingredients = {{type="fluid", name="low-enriched-uranium-hexafluoride", amount=100}, {"uranium-235", 1}},
        icon = "__EnchantedNuclearPort__/graphics/icons/highly-enriched-uranium-hexafluoride.png",
        icon_size = 64,
        subgroup = "intermediate-product",
        ...
        results = 
        {
            {type="fluid", name="highly-enriched-uranium-hexafluoride", amount=100},
        },
        allow_decomposition = false
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/uranium-238-hex.png",
        icon_size = 64,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/uranium-235-hex.png",
        icon_size = 64,
        subgroup = "intermediate-product",
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/icons/hydrofluoric-acid.png",
        icon_size = 64,
        category = "chemistry",
        enabled = false,
        energy_required = 6,
        ...
        subgroup = "fluid-recipes",
        order = "a[fluid-chemistry]-f[hydrofluoric-acid]",
        crafting_machine_tint =
        {
    ...
    icon = "__EnchantedNuclearPort__/graphics/icons/burial-uranium-hexafluoride.png",
    icon_size = 64,
    subgroup = "intermediate-product",
    ...
    icon = "__EnchantedNuclearPort__/graphics/icons/burial-uranium-oxide.png",
    icon_size = 64,
    subgroup = "intermediate-product",
    ...
    icon = "__EnchantedNuclearPort__/graphics/icons/burial-nuclear-waste.png",
    icon_size = 64,
    subgroup = "intermediate-product",
