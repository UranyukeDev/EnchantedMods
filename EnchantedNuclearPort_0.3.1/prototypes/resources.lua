...
{
  {
    ...
    minable =
    {
      ...
      mining_time = 2,
      result = "thorium-ore",
      required_fluid = "hydrofluoric-acid",
      fluid_amount = 25,
    },
    ...
    stages =
    {
      sheet =
    {
      filename = "__EnchantedNuclearPort__/graphics/resources/thorium-ore.png",
      priority = "extra-high",
      width = 64,
      height = 64,
      frame_count = 8,
      ...
      hr_version =
      {
        filename = "__EnchantedNuclearPort__/graphics/resources/hr-thorium-ore.png",
        priority = "extra-high",
        width = 128,
        height = 128,
        frame_count = 8,
