...
{
	{
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/plutonium-fuel-reprocessing.png",
        icon_size = 128,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/neptunium-fuel-reprocessing.png",
        icon_size = 128,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/very-high-temp-nuclear-reactor.png",
        icon_size = 128,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/thorium-processing.png",
        icon_size = 128,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/thorium-neutron-absorption.png",
        icon_size = 128,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/thorium-fuel-reprocessing.png",
        icon_size = 128,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/molten-salt-nuclear-reactor.png",
        icon_size = 128,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__EnchantedNuclearPort__/graphics/technology/nuclear-waste-container.png",
        icon_size = 128,
        effects =
        {
            {
